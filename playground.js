...
for (let rowIndex = 0; rowIndex < rows; rowIndex++) {
  ...
  tileRow.setAttribute("id", "row" + rowIndex); //Precisamos dos atributos aqui, para podermos acessar
  tileRow.setAttribute("class", "tile-row"); //Classe 
